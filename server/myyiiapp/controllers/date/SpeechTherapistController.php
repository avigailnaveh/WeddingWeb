...
class SpeechTherapistController extends Controller {

    public function actionImportSpeechTherapist()
    {
        echo "\nהתחלת הפונקציה...";
        ...
        $rows = (new Query())->from('_speech_therapist')->each(200);
        echo "\n התחיל עיבוד נתונים...";
        ...
        foreach ($rows as $row) {
            ...
            $mainSpecialization = trim($row['normal_expertise'] ?? '');
            ...
            if ($foundProfessional) {
                ...
                if (!$foundProfessional->save()) {
                    ...
                    echo "\nמקצוען עודכן בהצלחה";
                    $this->updateProfessionalDetails($foundProfessional, $row, $careList, $mainSpecialization, $city, $phoneNumbers);
                }
                ...
                $this->updateProfessionalDetails($professional, $row, $careList, $mainSpecialization, $city, $phoneNumbers);
            }
        }
    ...
    private function updateProfessionalDetails($professional, $row, &$careList, $mainSpecialization, $city, $phoneNumbers)
    {
