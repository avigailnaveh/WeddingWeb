...
class EasyPhysiotherapyController extends Controller {

    public function actionImportEasyPhysiotherapy()
    {
        echo "\nהתחלת הפונקציה...";
        
        $rows = (new Query())->from('_easy_physiotherapy')->each(200);
        echo "\n התחיל עיבוד נתונים...";
        ...
        foreach ($rows as $row) {
            ...
            if ($foundProfessional) {
                ...
                if (!$foundProfessional->save()) {
                    ...
                    echo "\nמקצוען עודכן בהצלחה";
                    $this->updateProfessionalDetails($foundProfessional, $row, $city, $phoneNumbers, $categories);
                }
                ...
                $this->updateProfessionalDetails($professional, $row, $city, $phoneNumbers, $categories);
            }
        }
    ...
    private function updateProfessionalDetails($professional, $row, $city, $phoneNumbers, $categories)
    {
