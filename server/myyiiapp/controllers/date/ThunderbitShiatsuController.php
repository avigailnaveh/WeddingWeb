...
class ThunderbitShiatsuController extends Controller {

    public function actionImportThunderbitShiatsu()
    {
        echo "\nהתחלת הפונקציה...";
        ...
        $rows = (new Query())->from('_thunderbit_shiatsu')->each(200);
        echo "\n התחיל עיבוד נתונים...";
