...
class HamenifaController extends Controller {

    public function actionImportHamenifa()
    {
        echo "\nהתחלת הפונקציה...";
        ...
        $rows = (new Query())->from('_hamenifa')->each(200);
        echo "\n התחיל עיבוד נתונים...";
        ...
        foreach ($rows as $row) {
            ...
            $mainSpecialization = trim($row['specialization'] ?? '');
