...
class MenoraDentistController extends Controller {

    public function actionImportMenoraDentist()
    {
        echo "\nהתחלת הפונקציה...";
        ...
        $rows = (new Query())->from('_menora_dentist')->each(200);
        echo "\n התחיל עיבוד נתונים...";
        $countrOfFound = 0;
        $counter = 0;
        foreach ($rows as $row) {
